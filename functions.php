...
function university_files() {
  ...
  wp_enqueue_script('our-vendors-js', get_theme_file_uri('/bundled-assets/vendors~scripts.7b56a904a7e4e8ce1af1.js'), NULL, '1.0', true);
  wp_enqueue_script('js', get_theme_file_uri('/bundled-assets/scripts.0bf35b216341a0119ac8.js'), NULL, '1.0', true);
  wp_enqueue_style('styles', get_theme_file_uri('/bundled-assets/styles.0bf35b216341a0119ac8.css'));
...
add_filter( 'ai1wm_exclude_content_from_export', function( $exclude ) {
	$exclude[] = 'themes/modernTheme/node_modules';
	return $exclude;
} );
